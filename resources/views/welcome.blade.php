...
@Section('main-content')
    ...
    <nav class="navbar">
        ...
        <ul class="nav-links">
            ...
            <li><a href="https://drive.google.com/file/d/1rgrdP_6bMuFMyQrRuugQ2wTGXIsKl5t0/view?usp=sharing"
    ...
    <section id="home" class="hero">
        <div class="hero-text">
            ...
            <p>I'm <strong>Taifur Rahman</strong>, a passionate learner and researcher exploring tech, AI, and innovation.
            </p>
        </div>
        <div class="hero-img">
  ...
  <div class="about-container">
    ...
    <section id="research" class="project-section">
        ...
        <div class="project-container">
            ...
            <div class="project-card">
                <img src="https://cdn.prod.website-files.com/6077b42e4e8d6b13a8ea682a/640eb1bd2e494865ac01beb0_AI%20in%20Ag.jpg"
                    alt="Research 1">
            ...
            <div class="project-card">
                <img src="https://play-lh.googleusercontent.com/FvsmsXjwxPTe0e5Z4zh8WVb-RT_ZC5hFooEyLApIipWUtmGfktrJzl1p5RJa0-A7WOo1"
                    alt="Research 2">
            ...
            <div class="project-card">
                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRb7fADS2dFdxwuAwldhDV0yeP2QkSINSKrIw&s"
                    alt="Research 3">
    ...
    <section id="projects" class="project-section">
        ...
        <div class="project-container">
            ...
            <div class="project-card">
                <img src="https://static.vecteezy.com/system/resources/previews/022/223/650/non_2x/smart-ai-chat-bot-communicate-with-human-vector.jpg"
                    alt="Project 1">
                <h3>AI Chatbot</h3>
            ...
            <div class="project-card">
                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcThxKA7HvO10GTQBbTTroY57QxgaI-W6kfyUw&s"
                    alt="Project 2">
                <h3>Weather App</h3>
            ...
            <div class="project-card">
                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTH73xvHGihq0ZU_7-gCt6XgdAUlakKVu3pxA&s"
                    alt="Project 3">
    ...
    <section id="blog" class="blog-section">
        ...
        <div class="blog-container">
            ...
            <div class="blog-post">
                <img src="https://cdn.prod.website-files.com/60ef088dd8fef99352abb434/64502c47934b682e375a0876_AnyConv.com__Artificial%20Intelligence%20Blog%20Writing%20Using%20AI%20in%2060%20Minutes.webp"
                    alt="Blog Post 1" />
            ...
            <div class="blog-post">
                <img src="https://cdn.quokkalabs.com/blog/object/20231009104935_c14918e7b32d4f909ec92494e3651afa.webp"
                    alt="Blog Post 2" />
            ...
            <div class="blog-post">
                <img src="https://media.geeksforgeeks.org/wp-content/uploads/20240523171004/Applications-of-Deep-Learning-in-Healthcare.webp"
                    alt="Blog Post 3" />
    ...
    <footer class="footer">
        <div class="footer-content">
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQFJtGSYbETjjT-mckVeSMSQ6izsfNMQ6pE1w&s"
                alt="Signature" class="footer-signature" />
